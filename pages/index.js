      ...
      <main className={styles.main}>
        ...
        <section id="offer" className={styles.offer}>
          ...
          <div className={styles.offer__text}>
            <p>Серед тисяч товарів я і моя команда відібрали для вас найякісніший інвентрар для бару та зібрали це все в<br /><a href="#catalog">10 оригінальних наборів</a>. Кожен набір включає в себе інвентар за допомогою якого ти можеш приготувати будь-який класичний або авторський коктейль в домашніх умовах. Ми пропонуємо 4 різних кольори на вибір у різних варіаціях, тож не переймайся — ти точно знайдеш те, що ідеально підійде до твого інтер’єру.</p>
            <a href="#catalog">
