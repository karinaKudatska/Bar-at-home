...
export default function Product({isProductOpen, setIsProductOpen, product, addToCart, unFixBody, setIsVideoOpen, setVideoId}) {
  return (
    <Modal open={isProductOpen} style={{zIndex: 99999}}>
